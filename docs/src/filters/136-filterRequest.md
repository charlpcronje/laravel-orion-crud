...
## The type by default is `AND`

If you want to filter by 2 categories you can use `OR`
...
## 13.6.1 Update Posts Controller
...
## 13.6.2 POST Request - Filter Title `=`
...
## 13.6.3 Response - Filter on Title
...
## 13.6.4 POST Request - Filter `published =`
...
## 13.6.5 Response - Filter in `Published`
...
## 13.6.6 POST Request - Filter `id IN [1,2]`
...
## 13.6.7 Response - Filter in `id` in [1,2]
...
## 13.6.8 POST Request - Filter with `OR`
...
## 13.6.9 Response - Filter with `OR`
