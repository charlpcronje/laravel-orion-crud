...
## 14.2.1 POST Request - Sort Category ASC
...
## 14.2.2 Response - Sort Category ASC
...
## 14.2.3 POST Request - Sort Category ASC and Title ASC

This will basically group by cateogory and sort the titles within each cateogry as well
...
## 14.2.4 Response - Sort Category ASC and Title ASC
